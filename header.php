...
<!--[if (gt IE 9)|!(IE)]><!--> <html lang="en" class="no-js not-ie"> <!--<![endif]-->
  ...
  <section id="act-2" class="act">
    <div class="in">
      ...
      <div class="content">
        <img id="img-merch" src="<?= URL_BASE; ?>assets/img/merch.png?ver=<?= VER ?>" alt="" />
        <ul>
  ...
  <section id="act-3" class="act">
    <div class="in">
      <img id="merch-shirt" src="<?= URL_BASE; ?>assets/img/shirt.png?ver=<?= VER ?>" alt="Shirt + Card - $30" />
      <img id="merch-card" src="<?= URL_BASE; ?>assets/img/card.png?ver=<?= VER ?>" alt="Just the Card - $5" />
